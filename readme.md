...
Кеширование повышает отзывчивость системы.

Кешировать стоит те данные, которые редко меняются (операций чтения гараздо больше, чем операций обновлений, период 
использования данных гараздо больше, чем время формирования кеша).

Предполагается кешировать данные по заказам. Кеширование установить в Shop API и MES API.
